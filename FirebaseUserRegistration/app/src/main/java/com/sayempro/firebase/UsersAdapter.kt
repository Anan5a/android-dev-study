...
class UsersAdapter(var context: Context, var userList: ArrayList<User>) :
    ...
    inner class UserViewHolder(val adapterBinding: UserItemBinding) : ViewHolder(adapterBinding.root){}
...
//        return view
    ...
    override fun onBindViewHolder(holder: UserViewHolder, position: Int) {
        ...
        holder.adapterBinding.linearLayout.setOnClickListener {
            ...
            Toast.makeText(context, "Id ${userList[position].userId} was clicked", Toast.LENGTH_LONG).show()
        }
    }
}